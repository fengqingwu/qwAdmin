    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="组件预览" name="first">
            <div class="qwScrollFix" :style="{minHeight: sidebarHeight +'px',width: '300px',overflow: 'scroll'}">
                <comp ref="tree" :config="compConfig" @addNode="addNode" @editNode="editNode" @delNode="delNode"></comp>
...
<script>
import comp from "../../qwComponents/tree/tree.vue"
...
export default {
    ...
    data(){
        return {
            ...
            tmplStr:""+`<qwTree :config="compConfig"></qwTree>`,
            activeName: "first",
            compConfig:{  
