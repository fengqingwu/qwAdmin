...
<div class="qwFormDoc">
    <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="组件预览" name="first">
            <comp id="ueditor" v-model="data_" :config="compConfig"></comp>
            <p>当前数据：{{data_}}</p>
        </el-tab-pane>
...
<script>
import comp from "../../qwComponents/ueditor/ueditor.vue"
...
export default {
    ...
    data(){
        return {
            ...
            tmplStr:""+`<qwUeditor v-model="data_" :config="compConfig"></qwUeditor>`,
            activeName: "first",
            compConfig:{
                serverUrl: "your_upload_url",
